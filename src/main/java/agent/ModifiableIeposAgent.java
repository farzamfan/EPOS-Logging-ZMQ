 ...
 */
public class ModifiableIeposAgent<V extends DataType<V>> extends MultiObjectiveIEPOSAgent<V> implements Serializable {
	...
	private transient AgentState 				state;
	private transient ReorganizationStrategy 	strategy;
...
//		}
	...
	*/
	...
	public class ModifiableDownMessage extends MultiObjectiveIEPOSAgent.DownMessage implements Serializable {

		public boolean reorganization = false;
