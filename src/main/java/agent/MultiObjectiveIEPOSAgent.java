...
public class MultiObjectiveIEPOSAgent<V extends DataType<V>> extends IterativeTreeAgent<V,MultiObjectiveIEPOSAgent<V>.UpMessage,MultiObjectiveIEPOSAgent<V>.DownMessage> implements Serializable{
    ...
    // misc
    transient Optimization 								optimization;
    double 												lambda;
    double												alpha;
    double 												beta;
    double												gamma;
...
//            this.log(Level.FINER, "preliminary approved SubtreeDiscomfortSumSqr: " + this.subtreeDiscomfortSumSqr.get(0) + ", " + this.subtreeDiscomfortSumSqr.get(1));
    ...
    // message classes
    public class UpMessage extends IterativeTreeAgent.UpMessage implements java.io.Serializable {
    ...
    public class DownMessage extends IterativeTreeAgent.DownMessage implements java.io.Serializable {
