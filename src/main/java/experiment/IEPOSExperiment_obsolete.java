 ...
 *
 */
public class IEPOSExperiment_obsolete {
	...
	private static void runOneSimulation(Configuration config, Function<Integer, Agent> createAgent) {
		...
		IEPOSExperiment_obsolete.runSimulation(Configuration.numChildren, Configuration.numIterations,
	...
	public static void main(String[] args) {
		Logger log = Logger.getLogger(IEPOSExperiment_obsolete.class.getName());
		...
		for (int sim = 0; sim < Configuration.numSimulations; sim++) {
			...
			IEPOSExperiment_obsolete.runOneSimulation(config, createAgent);
		}
